    ...
    <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content" style="display: none;"> <!-- Set display: none untuk sembunyikan -->
    ...
    <script>
        $(document).ready(function() {
            $(".collapse-link").click(function() {
                const iboxContent = $(this).closest(".ibox").find(".ibox-content");
                iboxContent.slideToggle(200); // Toggle dengan animasi
                $(this).find('i').toggleClass("fa-chevron-up fa-chevron-down"); // Ubah ikon
            });
        });
    </script>
